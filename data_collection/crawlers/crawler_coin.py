...
from data_collection.utils.crawler_util import clean_text, ensure_dir, timestamp_to_text
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--user-data-dir",
        default="data_collection/tmp_chrome_profile",
        help="浏览器用户数据目录",
    )
    parser.add_argument(
        "--trust-env-proxy",
...
def run_html_fetch_stage(
    ...
    fetch_script = Path(__file__).resolve().parent.parent / "downloaders" / "fetch_coin_pages.py"
