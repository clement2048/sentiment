...
# ── System Prompt ──────────────────────────────────────
SYSTEM_PROMPT = """你是一个加密货币市场情绪分析专家。你需要分析用户在币安新闻下的评论，判断该用户对相关币种是看涨(bullish)、看跌(bearish)还是中性(neutral)。
...
{"sentiment": "bullish"|"bearish"|"neutral", "confidence": 0.0-1.0, "reason": "简短推理（中文，10-30字）"}"""
